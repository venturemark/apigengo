...
type UpdateI_Obj struct {
	...
	Property []*UpdateI_Obj_Property `protobuf:"bytes,2,rep,name=property,proto3" json:"property,omitempty"`
}
...
func (x *UpdateO) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_pbf_metupd_update_proto_rawDesc = []byte{
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x12, 0x39, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6d, 0x65, 0x74, 0x75,
	0x70, 0x64, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64,
...
var file_pbf_metupd_update_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_pbf_metupd_update_proto_goTypes = []interface{}{
	...
	nil,                               // 6: metupd.UpdateI_Obj.MetadataEntry
	nil,                               // 7: metupd.UpdateO.MetadataEntry
}
var file_pbf_metupd_update_proto_depIdxs = []int32{
	...
	6, // 2: metupd.UpdateI_Obj.metadata:type_name -> metupd.UpdateI_Obj.MetadataEntry
	...
	7, // 5: metupd.UpdateO.metadata:type_name -> metupd.UpdateO.MetadataEntry
