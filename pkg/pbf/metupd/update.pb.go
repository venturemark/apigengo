...
// UpdateO is the output for updating metric updates. The response will indicate
// which parts of the metric update got in fact updated.
//
//     {
//         "metric": true,
//         "update": false
...
type UpdateO struct {
	...
	// metric expresses if the metrics associated with the metric update got
	// updated or not.
	Metric bool `protobuf:"varint,1,opt,name=metric,proto3" json:"metric,omitempty"`
	// update expresses if the update associated with the metric update got
	// updated or not.
...
var file_pbf_metupd_update_proto_rawDesc = []byte{
	...
	0x22, 0x39, 0x0a, 0x07, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x12, 0x16, 0x0a, 0x06, 0x6d,
	0x65, 0x74, 0x72, 0x69, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x6d, 0x65, 0x74,
	0x72, 0x69, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e,
