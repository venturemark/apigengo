...
func (c *aPIClient) Create(ctx context.Context, in *CreateI, opts ...grpc.CallOption) (*CreateO, error) {
	out := new(CreateO)
	err := c.cc.Invoke(ctx, "/metric.API/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Delete(ctx context.Context, in *DeleteI, opts ...grpc.CallOption) (*DeleteO, error) {
	out := new(DeleteO)
	err := c.cc.Invoke(ctx, "/metric.API/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Search(ctx context.Context, in *SearchI, opts ...grpc.CallOption) (*SearchO, error) {
	out := new(SearchO)
	err := c.cc.Invoke(ctx, "/metric.API/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Update(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error) {
	out := new(UpdateO)
	err := c.cc.Invoke(ctx, "/metric.API/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
