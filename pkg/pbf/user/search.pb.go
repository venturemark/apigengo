...
type SearchO_Obj_Property struct {
	...
	Prof []*SearchO_Obj_Property_Prof `protobuf:"bytes,4,rep,name=prof,proto3" json:"prof,omitempty"`
}
...
func (x *SearchO_Obj_Property) GetProf() []*SearchO_Obj_Property_Prof {
	if x != nil {
		return x.Prof
	}
	return nil
...
type SearchO_Obj_Property_Prof struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Desc string `protobuf:"bytes,1,opt,name=desc,proto3" json:"desc,omitempty"`
	Vent string `protobuf:"bytes,2,opt,name=vent,proto3" json:"vent,omitempty"`
}

func (x *SearchO_Obj_Property_Prof) Reset() {
	*x = SearchO_Obj_Property_Prof{}
	if protoimpl.UnsafeEnabled {
...
func (x *SearchO_Obj_Property_Prof) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchO_Obj_Property_Prof) ProtoMessage() {}

func (x *SearchO_Obj_Property_Prof) ProtoReflect() protoreflect.Message {
	mi := &file_pbf_user_search_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchO_Obj_Property_Prof.ProtoReflect.Descriptor instead.
func (*SearchO_Obj_Property_Prof) Descriptor() ([]byte, []int) {
	return file_pbf_user_search_proto_rawDescGZIP(), []int{10}
}

func (x *SearchO_Obj_Property_Prof) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *SearchO_Obj_Property_Prof) GetVent() string {
	if x != nil {
		return x.Vent
	}
	return ""
...
var file_pbf_user_search_proto_rawDesc = []byte{
	...
	0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x53, 0x0a,
	0x07, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x12, 0x23, 0x0a, 0x03, 0x61, 0x70, 0x69, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x49, 0x5f, 0x41, 0x50, 0x49, 0x52, 0x03, 0x61, 0x70, 0x69, 0x12, 0x23, 0x0a,
	0x03, 0x6f, 0x62, 0x6a, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x5f, 0x4f, 0x62, 0x6a, 0x52, 0x03, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	0x32, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x5f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x4f, 0x5f, 0x41, 0x50, 0x49, 0x52, 0x03, 0x61, 0x70, 0x69, 0x12, 0x23, 0x0a, 0x03, 0x6f,
	0x62, 0x6a, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	...
	0x0b, 0x32, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4f,
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61,
	...
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	,
...
var file_pbf_user_search_proto_goTypes = []interface{}{
	...
	(*SearchI_API)(nil),               // 1: user.SearchI_API
	(*SearchI_API_Chunking)(nil),      // 2: user.SearchI_API_Chunking
	(*SearchI_Obj)(nil),               // 3: user.SearchI_Obj
	(*SearchI_Obj_Property)(nil),      // 4: user.SearchI_Obj_Property
	(*SearchO)(nil),                   // 5: user.SearchO
	(*SearchO_API)(nil),               // 6: user.SearchO_API
	(*SearchO_API_Chunking)(nil),      // 7: user.SearchO_API_Chunking
	(*SearchO_Obj)(nil),               // 8: user.SearchO_Obj
	(*SearchO_Obj_Property)(nil),      // 9: user.SearchO_Obj_Property
	(*SearchO_Obj_Property_Prof)(nil), // 10: user.SearchO_Obj_Property_Prof
	nil,                               // 11: user.SearchI_Obj.MetadataEntry
	nil,                               // 12: user.SearchO_Obj.MetadataEntry
}
var file_pbf_user_search_proto_depIdxs = []int32{
	1,  // 0: user.SearchI.api:type_name -> user.SearchI_API
	3,  // 1: user.SearchI.obj:type_name -> user.SearchI_Obj
	2,  // 2: user.SearchI_API.chunking:type_name -> user.SearchI_API_Chunking
	11, // 3: user.SearchI_Obj.metadata:type_name -> user.SearchI_Obj.MetadataEntry
	4,  // 4: user.SearchI_Obj.property:type_name -> user.SearchI_Obj_Property
	6,  // 5: user.SearchO.api:type_name -> user.SearchO_API
	8,  // 6: user.SearchO.obj:type_name -> user.SearchO_Obj
	7,  // 7: user.SearchO_API.chunking:type_name -> user.SearchO_API_Chunking
	12, // 8: user.SearchO_Obj.metadata:type_name -> user.SearchO_Obj.MetadataEntry
	9,  // 9: user.SearchO_Obj.property:type_name -> user.SearchO_Obj_Property
	10, // 10: user.SearchO_Obj_Property.prof:type_name -> user.SearchO_Obj_Property_Prof
...
func file_pbf_user_search_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbf_user_search_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchO_Obj_Property_Prof); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
