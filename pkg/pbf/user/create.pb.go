...
type CreateI_Obj_Property struct {
	...
	Prof []*CreateI_Obj_Property_Prof `protobuf:"bytes,4,rep,name=prof,proto3" json:"prof,omitempty"`
}
...
func (x *CreateI_Obj_Property) GetProf() []*CreateI_Obj_Property_Prof {
	if x != nil {
		return x.Prof
	}
	return nil
...
type CreateI_Obj_Property_Prof struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateI_Obj_Property_Prof) Reset() {
	*x = CreateI_Obj_Property_Prof{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateI_Obj_Property_Prof) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateI_Obj_Property_Prof) ProtoMessage() {}

func (x *CreateI_Obj_Property_Prof) ProtoReflect() protoreflect.Message {
	mi := &file_pbf_user_create_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateI_Obj_Property_Prof.ProtoReflect.Descriptor instead.
func (*CreateI_Obj_Property_Prof) Descriptor() ([]byte, []int) {
	return file_pbf_user_create_proto_rawDescGZIP(), []int{4}
}

func (x *CreateI_Obj_Property_Prof) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *CreateI_Obj_Property_Prof) GetVent() string {
	if x != nil {
		return x.Vent
	}
	return ""
...
var file_pbf_user_create_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x53, 0x0a,
	0x07, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x12, 0x23, 0x0a, 0x03, 0x61, 0x70, 0x69, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x72, 0x65,
	...
	0x72, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x5f, 0x4f, 0x62, 0x6a, 0x52, 0x03, 0x6f,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x32, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x5f,
	...
	0x02, 0x38, 0x01, 0x22, 0x87, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x5f,
	0x4f, 0x62, 0x6a, 0x5f, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04,
	...
	,
...
var file_pbf_user_create_proto_goTypes = []interface{}{
	...
	(*CreateI_API)(nil),               // 1: user.CreateI_API
	(*CreateI_Obj)(nil),               // 2: user.CreateI_Obj
	(*CreateI_Obj_Property)(nil),      // 3: user.CreateI_Obj_Property
	(*CreateI_Obj_Property_Prof)(nil), // 4: user.CreateI_Obj_Property_Prof
	(*CreateO)(nil),                   // 5: user.CreateO
	(*CreateO_API)(nil),               // 6: user.CreateO_API
	(*CreateO_Obj)(nil),               // 7: user.CreateO_Obj
	nil,                               // 8: user.CreateI_Obj.MetadataEntry
	nil,                               // 9: user.CreateO_Obj.MetadataEntry
}
var file_pbf_user_create_proto_depIdxs = []int32{
	1, // 0: user.CreateI.api:type_name -> user.CreateI_API
	2, // 1: user.CreateI.obj:type_name -> user.CreateI_Obj
	8, // 2: user.CreateI_Obj.metadata:type_name -> user.CreateI_Obj.MetadataEntry
	3, // 3: user.CreateI_Obj.property:type_name -> user.CreateI_Obj_Property
	4, // 4: user.CreateI_Obj_Property.prof:type_name -> user.CreateI_Obj_Property_Prof
	6, // 5: user.CreateO.api:type_name -> user.CreateO_API
	7, // 6: user.CreateO.obj:type_name -> user.CreateO_Obj
	9, // 7: user.CreateO_Obj.metadata:type_name -> user.CreateO_Obj.MetadataEntry
...
func file_pbf_user_create_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbf_user_create_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateI_Obj_Property_Prof); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
